...
In the \hyperlink{classApplication}{Application} class are stored all the data of one application; it's provided also a method to evaluate the objective function of the application 
