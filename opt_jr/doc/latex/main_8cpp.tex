...
1) Read parameters from command line and save them in an \char`\"{}opt\-Jr\-Parameters\char`\"{} object

2) read informations from \char`\"{}wsi\-\_\-config.\-xml\char`\"{} file and save it in a \char`\"{}s\-Configuration\char`\"{} object (which is unordered\-\_\-map(string,string))
