...
\hyperlink{classConfiguration}{Configuration} is a class which stores data from the configuration file. 
...
extract\-\_\-item parses input from configuration file. 
...
Overloading of operator \mbox{[}\mbox{]} allows easy access to configuration data. 
