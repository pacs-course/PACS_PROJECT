...
\item 
void \hyperlink{classBatch_a327fdf85cb600d4bb50ff32c2462c699}{write\-Results} (M\-Y\-S\-Q\-L $\ast$conn, char $\ast$db\-Name, \hyperlink{classBatch}{Batch} \&App\-\_\-manager, \hyperlink{classoptJrParameters}{opt\-Jr\-Parameters} \&par)
...
It calculates nu indices for each application and stores it in each \char`\"{}\-Application\char`\"{} object. 
...
\hypertarget{classBatch_a327fdf85cb600d4bb50ff32c2462c699}{\index{Batch@{Batch}!write\-Results@{write\-Results}}
...
\item[{{\bf opt\-Jr\-Parameters} \&}]{par}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [friend]}}}\label{classBatch_a327fdf85cb600d4bb50ff32c2462c699}
